  ...
  showBalance()
{
  ...
  if(total<0)
  {
    this.budget.classList.remove("showGreen","showBlack");
    this.budget.classList.add("showRed");
  }
  else if(total>0)
  {
    this.budget.classList.remove("showRed","showBlack");
    this.budget.classList.add("showGreen");
  }
  else if(total == 0)
  {
    this.budget.classList.remove("showGreen","showRed");
...
editExpense(element)
{
  ...
  let parent = parentElement.parentElement.parentElement;
